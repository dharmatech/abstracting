...
(define (f-triangles)
  ...
  (when (iterate?)
        ...
        (block (lambda () (hue 10) (saturation 0.9) (brightness 0.33) (triangle)))
...
(define (f-squares)
  ...
  (when (iterate?)
        ...
        (block (lambda () (hue 220) (saturation 0.90) (brightness 0.33) (square)))
...
(set! *background* (lambda () (hue 66) (saturation 0.4) (brightness 0.5)))

(set! *viewport* (vec -5 10 -5 10))

(set! *threshold* 0.001)

(set! *start-shape* (lambda () (start)))
