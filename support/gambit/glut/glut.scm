...
(define *glut-idle-func* #f)

(c-define (basic-idle-func)
          ()
          void
          "basicIdleFunc"
          ""
...
(define (glutIdleFunc proc)
  (set! *glut-idle-func* proc)
  ((c-lambda () void " glutIdleFunc ( basicIdleFunc ) ; ")))
...
(define (glutKeyboardFunc proc)
  ...
  ((c-lambda () void " glutKeyboardFunc ( basicKeyboardFunc ) ; ")))
...
;;   (c-lambda (scheme-object) void "glutReshapeFunc( basicReshapeFunc ) ;"))
...
(define *glut-mouse-func* #f)

(c-define (basic-mouse-func a b c d)
          (int int int int)
          void
          "basicMouseFunc"
          ""
          (*glut-mouse-func* a b c d))

(define (glutMouseFunc proc)
  (set! *glut-mouse-func* proc)
  ((c-lambda () void " glutMouseFunc ( basicMouseFunc ) ; ")))
...
(define *glut-passive-motion-func* #f)

(c-define (basic-passive-motion-func a b)
          (int int)
          void
          "basicPassiveMotionFunc"
          ""
          (*glut-passive-motion-func* a b))

(define (glutPassiveMotionFunc proc)
  (set! *glut-passive-motion-func* proc)
  ((c-lambda () void " glutPassiveMotionFunc ( basicPassiveMotionFunc ) ; ")))
