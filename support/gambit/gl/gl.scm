...
;; glGetDoublev ( ___arg1 , ___GET_F64VECTOR( ___arg2 ) ) ;
...
" glLoadMatrixd ( ___CAST ( ___F64* , ___BODY ( ___arg1 ) ) ) ; "))
...
(define glMultMatrixd
  (c-lambda (scheme-object)
            void
" glMultMatrixd ( ___CAST ( ___F64* , ___BODY ( ___arg1 ) ) ) ; "))
