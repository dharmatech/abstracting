...
(defmacro typedef (type new)
  `(ffi-add-alias-of-attribute-entry! ',new ',type))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;; (defmacro c-structure (name . fields)
...
;;            (let ((type       (list-ref field 0))
;;                  (field-name (list-ref field 1)))
...
;;                `(,field-name-string (,getter ',type) (,setter ',type)))))))

;;     (let ((fields (map rewrite-field fields)))

;;       `(define-c-struct (,name/string ,constructor-name (include "X11/Xlib.h"))
;;          ,@fields))))
...
(defmacro c-function (return name parameters)
  (let ((name/string (symbol->string name)))
    `(define ,name
       (foreign-procedure ,name/string ',parameters ',return))))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;; (foreign-file "/usr/X11R7/lib/libX11.so")

(foreign-file "libX11.so")

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(typedef boxed bytevector)
...
(typedef bytevector XSetWindowAttributes*)
(typedef void* XTextItem*)
(typedef void* XTextItem16*)
(typedef void* XwcTextItem*)
(typedef bytevector XWindowAttributes*)
(typedef bytevector XWindowChanges*)
...
;; Larceny specific
(c-function void* XSetErrorHandler ((-> (void* void*) int)))
