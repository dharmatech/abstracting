 ...
 */
 ...
 /* void  test_glGetDoublev( GLenum pname, blob params ); */

 /* void  byte_vector_glGetDoublev( GLenum pname, ___byte_vector params ); */

 /* void  test_b_glGetDoublev( GLenum pname, ___byte_vector *params ); */

 /* void  test_c_glGetDoublev( GLenum pname, ___blob params ); */
 ...
 */
 ...
 // void  glLoadMatrixd( const ___byte_vector m );
 
 void  glLoadMatrixf( const GLfloat *m );

 void  glMultMatrixd( const GLdouble *m );

 // void  glMultMatrixd( const ___byte_vector m );
